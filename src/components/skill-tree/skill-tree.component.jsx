    ...
    if (!initialRun || !isSkillTreeDataUpdated) {
      ...
      function onPointAllocated(node) {
        ...
        const updatedTotalAllocatedPoints =
          calculateTotalAllocatedPoints(nodes);
      ...
      // ========================================= UPDATE AFTER URL LOAD
      if (loadFromUrl) {
        const updatedTotalAllocatedPoints =
          calculateTotalAllocatedPoints(nodes);

        linkElements = updateLinkElements();
        updateLinksOnNodeAllocation(updatedTotalAllocatedPoints);
